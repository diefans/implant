...
latex_documents = [
    (master_doc, 'implant.tex', 'implant Documentation',
     'Oliver Berger', 'manual'),
]
...
man_pages = [
    (master_doc, 'implant', 'implant Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'implant', 'implant Documentation',
     author, 'implant', 'One line description of project.',
     'Miscellaneous'),
]
